...
public interface ShowCommandResponse{
    ...
    record Ack(ShowCommandError error) implements com.example.cinema.show.ShowCommandResponse {
    ...
    record ShowSeatStatusCommandResponse(String showId, int seatNumber, ShowState.SeatStatus seatStatus, ShowCommandError error) implements ShowCommandResponse{
