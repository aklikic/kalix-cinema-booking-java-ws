...
sealed public interface ShowEvent {
    ...
    record ShowCreated(String showId, String title, List<ShowState.Seat> seats) implements ShowEvent {
    }
    @TypeName("seat-reserved")
    record SeatReserved(String showId, String walletId, String reservationId, int seatNumber, BigDecimal price, int availableSeatsCount) implements ShowEvent {
    }
