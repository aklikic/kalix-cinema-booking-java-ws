...
class ShowStateTest {
  ...
  public void shouldReserveTheSeat() {
    ...
    assertEquals(ShowState.SeatStatus.RESERVED,updatedShow.seats().get(seatNumberToReserve).status());
  }
  ...
  public void shouldCancelSeatReservation() {
    ...
    assertEquals(ShowState.SeatStatus.AVAILABLE,updatedShow.seats().get(seatNumberToReserve).status());
  }
